...
const getVisibleExpenses = (expenses, {text, sortBy, startDate, endDate}) => { 
	...
	const textMatch = lowerDescription.includes(filterText);
...
const expenseTwo = store.dispatch(addExpense({ description: 'food', amount: 500, note: 'I was hungry', createdAt: 1000 }));
